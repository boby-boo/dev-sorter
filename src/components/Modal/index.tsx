...
import { Button } from "..";
import { selectAllGameTime, selectCurrentGameTime } from "../../features/selectors";
...
const Modal = () => {
    ...
    return createPortal(
        <div className="modal">
            ...
            <h2 className="modal__title">You sorted the <span>dev stack</span> in {currentGameTime} seconds</h2>
            <ul className="modal__list">    
                <li className="modal__item"><span>Best time</span>: {statistic.bestTime}</li>
                <li className="modal__item"><span>Worst time</span>: {allTimeGameQty === 1? '-' :statistic.worstTime}</li>
            </ul>
